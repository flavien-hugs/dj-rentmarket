...
class OrdersModel(models.Model):
    order_id = models.CharField('ID commande', max_length=255, blank=True)
    first_name = models.CharField('Nom', max_length=50)
    last_name = models.CharField('Prénoms', max_length=50)
    company = models.CharField(
        'Entreprise (optionnel)', max_length=50, blank=True)
    ...
    apartement = models.CharField(
        'Appartement (optionnel)', max_length=30, blank=True)
